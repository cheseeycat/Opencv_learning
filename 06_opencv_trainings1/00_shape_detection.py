...
img = cv2.imread("C:/Users/Melih/Downloads/polygons.png")
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
_, thresh = cv2.threshold(gray, 240, 255, cv2.THRESH_BINARY)

contours,_ = cv2.findContours(thresh, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE) #aradığımız resim dışında her şey otomatik olarak siyah olacak şekilde ayarlandı.
